...
if __name__ == '__main__':
    ...
    # Read in user input
    today = datetime.date.today()
    if os.path.exists(f'{Path.home()}/blinding_scheme_{today}.txt'):
        os.remove(f'{Path.home()}/blinding_scheme_{today}.txt')
    
    print_both('Important Notice to External Blinder:')
    print_both('Retain this screen output from this code for unblinding.')
    ...
    print_both('Encoding shifts to a pickle for blinding script.')
    ...
    print_both('Decoded dictionaries == original?')
